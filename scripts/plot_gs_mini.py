...
# %%
fig, ax = plt.subplots()
data[::2].plot(x="Lambda", y="Energy0", marker="o", label=rf"$\lambda$={l} odd", ax=ax)
data[1::2].plot(
    x="Lambda", y="Energy0", marker="o", label=rf"$\lambda$={l} even", ax=ax
)
...
data.diff()[::2].abs().plot(
    y="Energy0", marker="o", label=rf"$\lambda$={l} odd", logy=True, ax=ax
)
data.diff()[1::2].abs().plot(
    y="Energy0", marker="o", label=rf"$\lambda$={l} even", logy=True, ax=ax
)
...
fig, ax = plt.subplots()
data[::2].abs().plot(
    x="Lambda", y="Energy0", marker="o", label=rf"$\lambda$={l} odd", logy=True, ax=ax
)
data[1::2].abs().plot(
    x="Lambda", y="Energy0", marker="o", label=rf"$\lambda$={l} even", logy=True, ax=ax
)
ax.set_ylabel(r"$E_0$", rotation=90)
ax.set_xlabel(r"$\Lambda$")
ax.grid()
